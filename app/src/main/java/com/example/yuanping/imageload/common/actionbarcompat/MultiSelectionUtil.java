...
package com.example.yuanping.imageload.common.actionbarcompat;
...
public class MultiSelectionUtil {
    ...
    public static class Controller {
         ...
         * {@link AppCompatActivity#onSaveInstanceState(Bundle)} or
         * {@link android.support.v4.app.Fragment#onSaveInstanceState(Bundle)
